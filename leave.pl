...
$cgiurl = "leave/leave.pl";  #un-rem line for production
...
$sendmurl = "leave/sendm.pl"; #un-rem line for production
...
print  "<option value='Howington, David'>Howington, David</option>\n";
print  "<option value='Johnson, Ronald'>Johnson, Ronald</option>\n";
print  "<option value='Kaim, Fevzi'>Kaim, Fevzi</option>\n";
print  "<option value='Lewter, Terry Lane'>Lewter, Terry Lane</option>\n";
